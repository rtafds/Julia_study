...
# !!! Main.UserApp is configured as an alias for Main.Example01 and you might encounter it in some tests
using Main.Example01, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Example01 tests" begin
  @includetests ARGS
end
